...
cd /opt/ansible/ansible_v1 || log_and_exit "Erro ao acessar o diretório /opt/ansible/ansible_v1"
ansible-playbook -i ./inventory/inventory_com_agrupamentos.yml master.yml || log_and_exit "Erro ao executar o playbook"
